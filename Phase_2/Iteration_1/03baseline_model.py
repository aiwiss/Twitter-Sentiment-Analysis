...
results_path = helper.results_path + 'Iteration1\\01Baseline\\'
...
for i, clf in enumerate(classifiers):
    ...
    helper.write_avg_results(scores, classifier_names[i], f'{results_path}baseline_model_results.txt')
...
helper.output_cv_results(results, results_path)
